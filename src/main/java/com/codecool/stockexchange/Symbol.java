...
@Component
public class Symbol {
    private Map<String, String> stocklist = Map.of(
    ...
    private Map<String, Integer[]> quotes = Map.of(
            "OBLN", new Integer[] {1, 2},
            "GEVO", new Integer[] {1, 2},
            "PBR", new Integer[] {1, 2},
            "BB", new Integer[] {1, 2},
            "BABA", new Integer[] {1, 2},
            "SENS",new Integer[] {1, 2},
            "MSFT", new Integer[] {1, 2},
            "BNGO", new Integer[] {1, 2},
            "AMC", new Integer[] {1, 2},
            "GM", new Integer[] {1, 2});
